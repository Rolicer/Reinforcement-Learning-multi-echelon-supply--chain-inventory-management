...
class NetInvMgmtMasterEnv(gym.Env):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.alpha = 1.00
        self.seed_int = 0
        # self.user_D = {(1,0): np.zeros(self.num_periods)} # default parameter
        self.user_D = {(1,0): [25., 23., 20., 17., 15., 14., 15., 17., 20., 22., 25., 26., 26., 24., 21., 18., 16., 14., 14., 15., 18., 21., 24., 25.]} # custom demand for each period. Demands created "Seasonal demand function.ipynb" file.
